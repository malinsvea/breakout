    ...
    public void update(long now) {
        ...
        // TODO  Main game loop, start functional decomposition from here
            ...
            if (hitted_item instanceof Paddle) {
                this.ball.adjustIllegalPosition(this.paddle);
            }
            if (hitted_item != null) {
        ...
        private Rectangle checkIfBallHitBrickAndRemoveIt () {
            ...
            for (Brick brick : this.bricks) {
                if (this.ball.hit(brick)) {
                    ...
                    if (!hasLowerPointBricks(this.bricks, brick)){
                        this.bricks.remove(brick);
                        this.points = this.points + brick.getPoints();
                    }
                    return brick;
                }
            }
